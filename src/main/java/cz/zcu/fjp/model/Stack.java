...
/**
 * Class representing Stack information Contains info about basis, top and
 * instruction count Also contains info about list of items in stack
 */
public class Stack {
	...
	public Stack(TreeItem<StackItem> base, TreeItem<StackItem> top, int instructionCount, int level,
			ObservableList<StackItem> stackItems, TreeItem<StackItem> root) {
		super();
		setBase(base);
		setTop(top);
	...
	public Stack() {
		this(new TreeItem<StackItem>(new StackItem(1, 0)), new TreeItem<StackItem>(new StackItem(0, 0)), 0, -1,
				FXCollections.observableArrayList(), new TreeItem<StackItem>(new StackItem(-1, -1)));
	}
