...
public class Instruction {
	...
	public String toString() {
		return new StringBuilder("Instruction: ").append("Index - ").append(index).append("Instruction - ")
				.append(instruction).append("Level - ").append(level).append("Operand - ").append(operand)
				.append("Debug - ").append(debug).toString();
	}
}
